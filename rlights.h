...
#   endif //NO_EMBEDDED_SHADERS
    ...
    for (int i = 0; i < RLG_MAX_LIGHTS_PER_MATERIAL; i++)
    {
        ...
        float defaultCutOff = -1.0f;
        SetShaderValue(lightShader, light->locs.innerCutOff, &defaultCutOff, SHADER_UNIFORM_FLOAT);
        SetShaderValue(lightShader, light->locs.outerCutOff, &defaultCutOff, SHADER_UNIFORM_FLOAT);
